...
filtered = FILTER crimedata BY EqualsIgnoreCase(Domestic,'TRUE');

grpd = GROUP filtered BY District;

cntd = FOREACH grpd GENERATE group, COUNT(filtered);

STORE cntd INTO '/Users/nidhisarode/Desktop/EBDFinal/PigAnalysis/countdomesticviolenceondistricts';
